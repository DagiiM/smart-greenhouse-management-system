<x-app-layout>
  ...
  <table class="table table-striped">
    <thead>
        <h5 style="text-align:center">System Contact</h5>
      <tr>
        <th scope="col">#</th>
    ...
    <tr>
        ...
        <td>
            <a href="{{route('abilities.edit',$data)}}">
          ...
          <td>
            <form method="post" enctype="multipart/form-data" action="{{route('abilities.destroy',$data)}}">
              {{csrf_field()}}
              {{method_field('DELETE')}}
              <button type="submit">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
