...
<table class="table table-striped">
  <thead>
      <h5 style="text-align:center">System Images</h5>
    <tr>
      <th scope="col">#</th>
...
@foreach($data as $image)
  <tr>
      ...
      <td> <img src="../img/{{$image->image}}" alt="{{$image->subject}}" style="width:48px;height:48px"/></td>
      <td style="width:20%">
        <td>
...
<div class="col">
        ...
        <p class="ml-5">No images Available</p>
      </div>
@endif
