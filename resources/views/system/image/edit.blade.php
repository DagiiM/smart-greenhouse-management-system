...
<form method="put" enctype="multipart/form-data" action="{{route('images.update',$data)}}">
  <div class="row">

  <input type="file" name="image" class="form-control col-lg-6 col-sm-6 col-md-6" value="{{$data->image}}" required>
