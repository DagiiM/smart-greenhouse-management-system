...
@foreach($data as $service)
  <tr>
      ...
      <td>
        ...
        <td>
          <form method="post" enctype="multipart/form-data" action="{{route('services.destroy',['service'=>$service])}}">
            {{csrf_field()}}
            {{method_field('DELETE')}}
            <button type="submit">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div class="col">
        ...
        <p class="ml-5">No Services Available</p>
      </div>
@endif
</x-app-layout>
