...
<form method="put" enctype="multipart/form-data" action="{{route('contacts.edit',$data)}}">
  <div class="row">

  <input class="form-control col-lg-3 col-md-3 col-sm-3" type="text" autofocus placeholder="Name" value="{{$data->name}}" required/>
  <input class="form-control col-lg-3 col-md-3 col-sm-3" type="tel" autofocus placeholder="Subject" value="{{$data->mobile}}" required/>
