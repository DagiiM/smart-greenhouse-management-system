...
trait WebResponser
{
  ...
  /*
    ...
    $collection = $this->filterData($collection,$transformer);//filter Data from the collection

    $collection = $this->sortData($collection,$transformer);//Sort Data from the collection
